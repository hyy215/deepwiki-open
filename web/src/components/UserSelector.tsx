    ...
    return (
        <div className="flex flex-col gap-3">
            <div className="space-y-4">
                ...
                <div>
                    ...
                    {isCustomModel ? (
                        <input
                            ...
                            placeholder={
                                t.form?.customModelPlaceholder || 'Enter custom model name'
                            }
                            className="input-japanese block w-full px-2.5 py-1.5 text-sm rounded-md bg-transparent text-[var(--foreground)] focus:outline-none focus:border-[var(--accent-primary)]"
                        />
                    ) : (
                ...
                {modelConfig?.providers.find((p: Provider) => p.id === provider)
                    ?.supportsCustomModel && (
                    <div className="mb-2">
                        ...
                        {isFilterSectionOpen && (
                            <div className="mt-3 p-3 border border-[var(--border-color)]/70 rounded-md bg-[var(--background)]/30">
                                ...
                                <div className="mb-4">
                                    ...
                                    <textarea
                                        value={
                                            filterMode === 'exclude' ? excludedDirs : includedDirs
                                        }
                                        onChange={e => {
                                ...
                                <div>
                                    ...
                                    <textarea
                                        value={
                                            filterMode === 'exclude' ? excludedFiles : includedFiles
                                        }
                                        onChange={e => {
                                            if (filterMode === 'exclude') {
